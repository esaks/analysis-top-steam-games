...
# Read in data
data = pd.read_csv('/Users/emily/Library/CloudStorage/Box-Box/Coding/Steam analysis with basic web scraping in Python/top100games.csv')
...
print(genre_df_sorted) #Action, Adventure and RPG are the top genres
...
#print(plt.style.available) tells you available styling themes
...
# Does metacritic scores correlate with steam scores?
...
# Test Assumptions
# Resource: https://python.plainenglish.io/an-ultimate-guide-to-all-the-assumptions-of-the-linear-regression-ab764182529f

# Resource: https://www.sfu.ca/~mjbrydon/tutorials/BAinPy/10_multiple_regression.html
#Fit the model
...
# Resource: https://www.geeksforgeeks.org/python/how-to-standardize-data-in-a-pandas-dataframe/
...
# Log transformation of Y means that a 1-unit change in X changes y by beta times 100%, so a percent increase

# Genre differences in recommendation totals, grouped means and regression
# may need to create primary genre variable
...
# Resource: https://www.geeksforgeeks.org/python/how-to-create-dummy-variables-in-python-with-pandas/
# Resource:https://medium.com/@whyamit404/understanding-pandas-dummy-variables-29419cc19df8
